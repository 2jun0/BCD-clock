...
const minutesColumns = document.querySelectorAll('#minutes-column-wrapper .column');
const secondsColumns = document.querySelectorAll('#seconds-column-wrapper .column'); 
